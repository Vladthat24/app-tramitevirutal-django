...
class UnidOrg(models.Model):
    uorgccod = models.CharField(db_column='UorgCCod', primary_key=True, max_length=5)  # Field name made lowercase.
    uorgccodinst = models.ForeignKey('institucion.Institucion', models.DO_NOTHING, db_column='UorgCCodInst', blank=True, null=True)  # Field name made lowercase.
